var ReportController = function () {
    ...
    function loadTab1(isPageChanged) {
        ...
        $.ajax({
            ...
            url: '/admin/Report/GetAllSavingDirectPaging',
            dataType: 'json',
            beforeSend: function () {
    ...
    function loadTab2(isPageChanged) {
        ...
        $.ajax({
            ...
            url: '/admin/Report/GetAllSavingReferralPaging',
            dataType: 'json',
            beforeSend: function () {
    ...
    function loadTab3(isPageChanged) {
        ...
        $.ajax({
            ...
            url: '/admin/Report/GetAllSavingLeadershipPaging',
            dataType: 'json',
            beforeSend: function () {
    ...
    function loadTab4(isPageChanged) {
        ...
        $.ajax({
            ...
            url: '/admin/Report/GetAllLeadershipReferralPaging',
            dataType: 'json',
            beforeSend: function () {
                be.startLoading();
            },
