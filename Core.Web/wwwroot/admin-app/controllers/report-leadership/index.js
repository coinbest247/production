var ReportController = function () {
    ...
    function loadTab1(isPageChanged, txnTypeId, unit) {
        ...
        $.ajax({
            ...
            url: '/admin/Report/GetAllLeadershipTransactionsPaging',
            dataType: 'json',
            beforeSend: function () {
                be.startLoading();
            },
    ...
    function loadTab2(isPageChanged) {
        ...
        $.ajax({
            ...
            url: '/admin/Report/GetAllLeadershipSaleHistoriesPaging',
            dataType: 'json',
            beforeSend: function () {
                be.startLoading();
            },
    ...
    function loadTab3(isPageChanged) {
        ...
        $.ajax({
            ...
            url: '/admin/Report/GetAllLeadershipSavingHistoriesPaging',
            dataType: 'json',
            beforeSend: function () {
                be.startLoading();
            },
    ...
    function loadSummary() {
        ...
        $.ajax({
            ...
            url: '/admin/Report/GetAllLeadershipSummaryTransaction',
            dataType: 'json',
            beforeSend: function () {
                be.startLoading();
            },
