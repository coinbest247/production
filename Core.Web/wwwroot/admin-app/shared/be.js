var be = {
    ...
    verifyPaymentStaking: function (title, message, projectToken, okCallback) {
        ...
        Swal.fire({
            ...
            input: 'radio',
            inputOptions: {
                'ProjectToken': 'Wallet ' + projectToken,
                'USDT': 'Wallet USDT'
            },
    ...
    getImgPackage: function (package) {

        var imgUrl = "";

        if (package == 1000)
            imgUrl = "/images/packgae/package-01.png";

        else if (package == 2000)
            imgUrl = "/images/packgae/package-02.png";

        else if (package == 5000)
            imgUrl = "/images/packgae/package-03.png";

        else if (package == 10000)
            imgUrl = "/images/packgae/package-04.png";

        else if (package == 20000)
            imgUrl = "/images/packgae/package-05.png";

        else if (package == 30000)
            imgUrl = "/images/packgae/package-06.png";

        else if (package == 50000)
            imgUrl = "/images/packgae/package-07.png";

        else if (package == 100000)
            imgUrl = "/images/packgae/package-08.png";

        else if (package == 200000)
            imgUrl = "/images/packgae/package-09.png";

        else if (package == 500000)
            imgUrl = "/images/packgae/package-10.png";

        else if (package == 1000000)
            imgUrl = "/images/packgae/package-11.png";

        else if (package == 2000000)
            imgUrl = "/images/packgae/package-12.png";
